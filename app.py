...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Get information from product or sales documents",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
...
context = f"""You are an assistant to customers who comes to buy products or query about different products.
...
If the customer's question cannot be answered from the database, you can refer to the company sales or product details.
